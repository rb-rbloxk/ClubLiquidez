          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            ...
            <div className="flex space-x-4">
              <input
                ...
                className="flex-1 px-4 py-3 bg-dark-800 border border-gray-700 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-neon-blue focus:border-transparent"
              />
          ...
          <div className="flex items-center space-x-4">
            {socialLinks.map((social) => (
              <motion.a
                ...
                className="p-2 bg-dark-800 rounded-lg text-gray-400 hover:text-neon-blue hover:bg-dark-700 transition-all duration-200"
              >

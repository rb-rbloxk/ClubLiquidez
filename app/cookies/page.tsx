        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <div className="space-y-6">
              <h2 className="text-3xl font-bold text-slate-900 text-center mb-8">Types of Cookies We Use</h2>
              {cookieTypes.map((type, index) => (
                ...
                >
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      <h4 className="text-slate-900 font-semibold mb-2">Examples:</h4>
                    ...
                    <div>
                      <h4 className="text-slate-900 font-semibold mb-2">Duration:</h4>
                      <p className="text-slate-600 text-sm">{type.duration}</p>
                    </div>
                  </div>
                </motion.div>
              ))}
            ...
            <div className="bg-dark-800 rounded-2xl border border-slate-200 p-8">
              <div className="flex items-center space-x-3 mb-6">
                ...
                <h3 className="text-xl font-bold text-slate-900">Third-Party Cookies</h3>
              </div>
              <div className="space-y-4 text-slate-600">
                <p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-6">
                  <div className="p-4 bg-dark-700 rounded-lg">
                    <h4 className="text-slate-900 font-semibold mb-2">Analytics Services</h4>
                    <p className="text-sm text-slate-500">Google Analytics, Mixpanel</p>
                  </div>
                  <div className="p-4 bg-dark-700 rounded-lg">
                    <h4 className="text-slate-900 font-semibold mb-2">Payment Processors</h4>
                    <p className="text-sm text-slate-500">Stripe, PayPal</p>
                  </div>
                  <div className="p-4 bg-dark-700 rounded-lg">
                    <h4 className="text-slate-900 font-semibold mb-2">Security Services</h4>
                    <p className="text-sm text-slate-500">Cloudflare, reCAPTCHA</p>
                  </div>
                  <div className="p-4 bg-dark-700 rounded-lg">
                    <h4 className="text-slate-900 font-semibold mb-2">Social Media</h4>
                    <p className="text-sm text-slate-500">Twitter, LinkedIn</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-dark-800 rounded-2xl border border-slate-200 p-8">
              <div className="flex items-center space-x-3 mb-6">
                ...
                <h3 className="text-xl font-bold text-slate-900">Managing Your Cookie Preferences</h3>
              </div>
              <div className="space-y-4 text-slate-600">
                <p>
                ...
                <div className="space-y-4 mt-6">
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      <h4 className="text-slate-900 font-semibold">Browser Settings</h4>
                  ...
                  <div className="flex items-start space-x-3">
                    <CheckCircle className="w-5 h-5 text-neon-gold-champagne mt-0.5 flex-shrink-0" />
                    <div>
                      <h4 className="text-slate-900 font-semibold">Cookie Consent</h4>
                      <p className="text-sm text-slate-500">
                  ...
                  <div className="flex items-start space-x-3">
                    <CheckCircle className="w-5 h-5 text-neon-gold-champagne mt-0.5 flex-shrink-0" />
                    <div>
                      <h4 className="text-slate-900 font-semibold">Account Settings</h4>
                      <p className="text-sm text-slate-500">
            ...
            <div className="bg-dark-800 rounded-2xl border border-slate-200 p-8">
              <div className="flex items-center space-x-3 mb-6">
                ...
                <h3 className="text-xl font-bold text-slate-900">Impact of Disabling Cookies</h3>
              </div>
              <div className="space-y-4 text-slate-600">
                <p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-6">
                  <div className="p-4 bg-dark-700 rounded-lg">
                    <h4 className="text-slate-900 font-semibold mb-2">Essential Cookies</h4>
                    <p className="text-sm text-slate-500">
                      Disabling these may prevent basic platform functionality
                    </p>
                  </div>
                  <div className="p-4 bg-dark-700 rounded-lg">
                    <h4 className="text-slate-900 font-semibold mb-2">Performance Cookies</h4>
                    <p className="text-sm text-slate-500">
                      May reduce our ability to optimize platform performance
                    </p>
                  </div>
                  <div className="p-4 bg-dark-700 rounded-lg">
                    <h4 className="text-slate-900 font-semibold mb-2">Functional Cookies</h4>
                    <p className="text-sm text-slate-500">
                      Your preferences may not be remembered
                    </p>
                  </div>
                  <div className="p-4 bg-dark-700 rounded-lg">
                    <h4 className="text-slate-900 font-semibold mb-2">Marketing Cookies</h4>
                    <p className="text-sm text-slate-500">
            ...
            {/* Updates to Policy */}
            <div className="bg-dark-800 rounded-2xl border border-slate-200 p-8">
              <h3 className="text-xl font-bold text-slate-900 mb-6">Updates to This Policy</h3>
              <div className="space-y-4 text-slate-600">
                <p>

        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <div className="flex items-center justify-center space-x-3 mb-6">
              <Cookie className="w-8 h-8 text-[#b89428]" />
              <h1 className="text-5xl lg:text-6xl font-bold text-black">
                Cookie <span className="text-[#b89428]">Policy</span>
              </h1>
            </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <div className="space-y-6">
              <h2 className="text-3xl font-bold text-black text-center mb-8">Types of Cookies We Use</h2>
                ...
                >
                  <div className="flex items-start justify-between mb-4">
                    <div>
                      ...
                      <p className="text-neutral-600 text-sm leading-relaxed">{type.description}</p>
                    </div>
                    <div className="px-3 py-1 bg-neutral-100 border border-neutral-200 text-[#b89428] rounded-full text-xs font-semibold">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      <h4 className="text-black font-semibold text-sm mb-2">Examples:</h4>
                      <ul className="space-y-1">
                        {type.examples.map((example, idx) => (
                          <li key={idx} className="flex items-center space-x-2 text-neutral-600">
                            <CheckCircle className="w-4 h-4 text-[#b89428]" />
                    ...
                    <div>
                      <h4 className="text-black font-semibold text-sm mb-2">Duration:</h4>
                      <p className="text-neutral-600 text-sm font-medium">{type.duration}</p>
                    </div>
                  </div>
                </motion.div>
              ))}
            ...
            <div className="bg-white rounded-2xl border border-neutral-200 p-8 shadow-sm">
              <div className="flex items-center space-x-3 mb-6">
                ...
                <h3 className="text-xl font-bold text-black">Third-Party Cookies</h3>
              </div>
              <div className="space-y-4 text-neutral-700 leading-relaxed text-base">
                <p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-6">
                  <div className="p-4 bg-neutral-50 rounded-xl border border-neutral-200">
                    <h4 className="text-black font-bold mb-1">Analytics Services</h4>
                    <p className="text-sm text-neutral-600">Google Analytics, Mixpanel</p>
                  </div>
                  <div className="p-4 bg-neutral-50 rounded-xl border border-neutral-200">
                    <h4 className="text-black font-bold mb-1">Payment Processors</h4>
                    <p className="text-sm text-neutral-600">Stripe, Razorpay</p>
                  </div>
                  <div className="p-4 bg-neutral-50 rounded-xl border border-neutral-200">
                    <h4 className="text-black font-bold mb-1">Security Services</h4>
                    <p className="text-sm text-neutral-600">Cloudflare, reCAPTCHA</p>
                  </div>
                  <div className="p-4 bg-neutral-50 rounded-xl border border-neutral-200">
                    <h4 className="text-black font-bold mb-1">Social Media</h4>
                    <p className="text-sm text-neutral-600">Twitter, LinkedIn</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl border border-neutral-200 p-8 shadow-sm">
              <div className="flex items-center space-x-3 mb-6">
                <Settings className="w-6 h-6 text-[#b89428]" />
                <h3 className="text-xl font-bold text-black">Managing Your Cookie Preferences</h3>
              </div>
              <div className="space-y-4 text-neutral-700 leading-relaxed text-base">
                <p>
                ...
                <div className="space-y-4 mt-6">
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      <h4 className="text-black font-semibold">Browser Settings</h4>
                  ...
                  <div className="flex items-start space-x-3">
                    <CheckCircle className="w-5 h-5 text-[#b89428] mt-0.5 flex-shrink-0" />
                    <div>
                      <h4 className="text-black font-semibold">Cookie Consent</h4>
                      <p className="text-sm text-neutral-600">
                  ...
                  <div className="flex items-start space-x-3">
                    <CheckCircle className="w-5 h-5 text-[#b89428] mt-0.5 flex-shrink-0" />
                    <div>
                      <h4 className="text-black font-semibold">Account Settings</h4>
                      <p className="text-sm text-neutral-600">
            ...
            <div className="bg-white rounded-2xl border border-neutral-200 p-8 shadow-sm">
              <div className="flex items-center space-x-3 mb-6">
                ...
                <h3 className="text-xl font-bold text-black">Impact of Disabling Cookies</h3>
              </div>
              <div className="space-y-4 text-neutral-700 leading-relaxed text-base">
                <p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-6">
                  <div className="p-4 bg-neutral-50 rounded-xl border border-neutral-200">
                    <h4 className="text-black font-bold mb-1">Essential Cookies</h4>
                    <p className="text-sm text-neutral-600">
                      Disabling these may prevent basic platform functionality
                    </p>
                  </div>
                  <div className="p-4 bg-neutral-50 rounded-xl border border-neutral-200">
                    <h4 className="text-black font-bold mb-1">Performance Cookies</h4>
                    <p className="text-sm text-neutral-600">
                      May reduce our ability to optimize platform performance
                    </p>
                  </div>
                  <div className="p-4 bg-neutral-50 rounded-xl border border-neutral-200">
                    <h4 className="text-black font-bold mb-1">Functional Cookies</h4>
                    <p className="text-sm text-neutral-600">
                      Your preferences may not be remembered
                    </p>
                  </div>
                  <div className="p-4 bg-neutral-50 rounded-xl border border-neutral-200">
                    <h4 className="text-black font-bold mb-1">Marketing Cookies</h4>
                    <p className="text-sm text-neutral-600">
            ...
            {/* Updates to Policy */}
            <div className="bg-white rounded-2xl border border-neutral-200 p-8 shadow-sm">
              <h3 className="text-xl font-bold text-black mb-6">Updates to This Policy</h3>
              <div className="space-y-4 text-neutral-700 leading-relaxed text-base">
                <p>

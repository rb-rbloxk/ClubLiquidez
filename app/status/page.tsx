      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
            ...
            transition={{ duration: 0.8 }}
          >
            <h2 className="text-3xl font-bold text-slate-900 text-center mb-12">Service Status</h2>
                  ...
                  >
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="flex justify-between items-center">
                        ...
                        <span className="text-slate-900 font-semibold">{service.uptime}</span>
                      </div>
                      <div className="flex justify-between items-center">
                        <span className="text-slate-500">Last Incident:</span>
                        <span className="text-slate-600">{service.lastIncident}</span>
                      </div>
                    </div>
                  </motion.div>
                )
      ...
      <section className="py-16 bg-dark-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
            ...
            transition={{ duration: 0.8 }}
          >
            <h2 className="text-3xl font-bold text-slate-900 text-center mb-12">Uptime Statistics</h2>
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
              {[
                ...
                <motion.div
                  ...
                  className="text-center"
                >
                  <div className="text-2xl font-bold text-slate-900 mb-2">{stat.uptime}</div>
                  <div className="text-slate-500 mb-2">{stat.period}</div>
                  <div className="text-sm text-slate-500">{stat.incidents} incidents</div>
                </motion.div>
              ))}
            </div>
          </motion.div>
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
            ...
            transition={{ duration: 0.8 }}
          >
            <h2 className="text-3xl font-bold text-slate-900 text-center mb-12">Recent Incidents</h2>
            ...
            <div className="max-w-md mx-auto">
              <div className="flex space-x-4">
                <input
                  ...
                  className="flex-1 px-4 py-3 bg-dark-700 border border-slate-300 rounded-lg text-slate-900 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-neon-gold focus:border-transparent"
                />
                <button className="px-6 py-3 bg-neon-gold text-slate-900 rounded-lg hover:bg-neon-gold/80 transition-colors">
                  Subscribe
                </button>
              </div>
            </div>

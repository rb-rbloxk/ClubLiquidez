...
const StatusPage = () => {
  ...
  const getStatusColor = (status: string) => {
    switch (status) {
      case 'operational': return 'text-neon-green'
      case 'degraded': return 'text-neon-pink'
            ...
            <div className="max-w-md mx-auto">
              <div className="flex space-x-4">
                <input
                  ...
                  className="flex-1 px-4 py-3 bg-dark-700 border border-gray-600 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-neon-blue focus:border-transparent"
                />

          ...
          <div className="flex flex-col sm:flex-row justify-between items-center mb-8 space-y-4 sm:space-y-0">
            <div className="flex items-center space-x-4">
              ...
              <select
                ...
                className="bg-dark-800 border border-gray-700 rounded-lg px-4 py-2 text-white focus:outline-none focus:ring-2 focus:ring-neon-blue"
              >
              ...
              >
                <div className="flex items-start justify-between mb-4">
                  ...
                  <div className="flex items-center space-x-2">
                    <Eye className="w-4 h-4 text-gray-500 hover:text-neon-blue cursor-pointer transition-colors" />
                    <BarChart3 className="w-4 h-4 text-gray-500 hover:text-neon-blue cursor-pointer transition-colors" />
                  </div>
                </div>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center space-x-1">
                      ...
                      <span className={`font-semibold ${
                        market.changePercent >= 0 ? 'text-neon-green' : 'text-neon-pink'
                      }`}>

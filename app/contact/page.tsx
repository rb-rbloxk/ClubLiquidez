...
const ContactPage = () => {
  ...
  const offices = [
    ...
    },
    {
      ...
      phone: '+65 6789 0123',
      email: 'singapore@clubliquidez.com'
    }
  ]
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {contactMethods.map((method, index) => (
                <motion.div
                  ...
                  className="bg-dark-800 rounded-2xl border border-gray-700 p-6 hover:border-neon-blue/50 transition-all duration-300 group"
                >
                  <div className="flex items-center space-x-3 mb-4">
                    <div className="p-3 bg-dark-700 rounded-lg group-hover:bg-neon-blue/20 transition-colors">
                      <method.icon className="w-6 h-6 text-neon-blue" />
                    </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-neon-green text-sm">{method.response}</span>
                    </div>
                  </div>
                </motion.div>
              ))}
            ...
            <div className="bg-dark-800 rounded-2xl border border-gray-700 p-8">
              ...
              {submitStatus === 'success' && (
                ...
                >
                  ...
                  <span className="text-neon-green">Message sent successfully! We'll get back to you soon.</span>
                </motion.div>
              )}
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <input
                      ...
                      required
                      className="w-full px-4 py-3 bg-dark-700 border border-gray-600 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-neon-blue focus:border-transparent"
                    />
                  </div>
                  <div>
                    <label className="block text-sm font-medium text-gray-300 mb-2">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    required
                    rows={6}
                    className="w-full px-4 py-3 bg-dark-700 border border-gray-600 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-neon-blue focus:border-transparent resize-none"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {[
                ...
                },
                {
                  ...
                  answer: 'Yes, we use bank-grade security, cold storage for assets, and maintain SOC 2 compliance.'
                },
                {

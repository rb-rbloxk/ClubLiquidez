        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h1 className="text-5xl lg:text-6xl font-bold text-black mb-6">
              Trading <span className="text-[#b89428]">Tools</span>
            </h1>
              ...
              >
                <div className="flex items-center space-x-3 mb-4">
                  <div className="p-3 bg-neutral-100 rounded-xl border border-neutral-200 group-hover:border-brand-gold transition-colors">
                    <tool.icon className="w-6 h-6 text-[#b89428]" />
                  </div>
                  <h3 className="text-lg font-bold text-black">{tool.title}</h3>
                </div>
                <p className="text-neutral-600 text-sm leading-relaxed">{tool.description}</p>
              </motion.div>
            ))}
          </div>
        </div>
          ...
          >
            ...
            <div className="bg-neutral-50 rounded-2xl border border-neutral-200 p-8 shadow-sm">
              <div className="text-center mb-8">
                <h2 className="text-3xl font-bold text-black mb-2">Position Size Calculator</h2>
              ...
              {/* Values Section */}
              <div className="mb-8">
                <h3 className="text-lg font-bold text-black mb-6">Values</h3>
                <div className="space-y-4">
                  {/* Currency Pair */}
                  <div className="flex items-center justify-between gap-4">
                    <label className="text-sm font-semibold text-neutral-700 min-w-[140px]">
                      Currency Pair:
                    </label>
                    <select
                      value={selectedCurrencyPair}
                      onChange={(e) => setSelectedCurrencyPair(e.target.value)}
                      className="flex-1 px-4 py-2 bg-white border border-neutral-300 rounded-lg text-black focus:outline-none focus:ring-2 focus:ring-brand-gold text-sm font-medium"
                    >
                ...
                <div className="flex items-center gap-4 mt-6">
                  <button
                    ...
                    className="flex-1 px-6 py-3 bg-neutral-200 hover:bg-neutral-300 text-black rounded-full font-bold active:scale-[0.98] transition-all duration-200 cursor-pointer text-sm"
                  >
                    Reset
                  </button>
                  <button
                    ...
                    className="flex-1 px-6 py-3 bg-brand-gold hover:bg-[#c5a028] text-black rounded-full font-bold active:scale-[0.98] transition-all duration-200 shadow-sm cursor-pointer text-sm"
                  >
                    Calculate
                  </button>
                </div>
              ...
              {(() => {
                ...
                if (needsConversion) {
                  return (
                    <div className="mb-6 p-4 bg-white rounded-xl border border-neutral-200 shadow-sm">
                      <div className="flex items-center justify-between mb-2">
                        <span className="text-sm font-semibold text-neutral-700">
                          Exchange Rate Status:
                        </span>
                        {isLoadingRate ? (
                          <div className="flex items-center gap-2 text-[#b89428]">
                            <Loader2 className="w-4 h-4 animate-spin" />
                            <span className="text-xs font-medium">Fetching rate...</span>
                          </div>
                        ) : exchangeRate ? (
                      ...
                      {rateError && (
                        <p className="text-xs text-amber-600 mt-1 font-medium">{rateError}</p>
                      )}
                    </div>
                  )
                }
              ...
              <div className="border-t border-neutral-200 pt-8">
                <h3 className="text-lg font-bold text-black mb-6">Results</h3>
                        ...
                        <>
                          <div className="flex items-center justify-between gap-4">
                            ...
                            <div className="flex-1 flex flex-col items-end">
                              <input
                                ...
                                className="w-full px-4 py-2 bg-white border border-neutral-300 rounded-lg text-black font-semibold text-right"
                              />
                          ...
                          <div className="flex items-center justify-between gap-4">
                            ...
                            <input
                              ...
                              className="flex-1 px-4 py-2 bg-white border border-neutral-300 rounded-lg text-black font-semibold text-right"
                            />
                          </div>
                          <div className="flex items-center justify-between gap-4">
                            <label className="text-sm font-semibold text-neutral-700 min-w-[140px]">

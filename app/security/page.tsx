      ...
      <section className="pt-32 pb-16 bg-gradient-to-br from-dark-950 via-dark-900 to-dark-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <div className="inline-flex items-center space-x-2 px-4 py-2 bg-neon-green/20 border border-neon-green/30 rounded-full">
              <CheckCircle className="w-5 h-5 text-neon-green" />
              <span className="text-neon-green font-medium">SOC 2 Type II Certified</span>
            </div>
          </motion.div>
        </div>
      </section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {securityFeatures.map((feature, index) => (
                <motion.div
                  ...
                  className="bg-dark-800 rounded-2xl border border-gray-700 p-6 hover:border-neon-blue/50 transition-all duration-300"
                >
                ...
                >
                  <div className="flex items-center justify-between mb-4">
                    <div className="flex items-center space-x-3">
                      <cert.icon className="w-6 h-6 text-neon-blue" />
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {[
                ...
                >
                  <practice.icon className="w-12 h-12 text-neon-blue mx-auto mb-4" />
          ...
          >
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-center space-x-2">
                ...
                <span className="text-neon-pink font-semibold">security@clubliquidez.com</span>
              </div>
              <div className="flex items-center justify-center space-x-2">
                <Phone className="w-5 h-5 text-neon-blue" />
                <span className="text-neon-blue font-semibold">+1 (555) 123-4567</span>
              </div>
            </div>
          </motion.div>
        </div>

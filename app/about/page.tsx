              ...
              <div className="bg-dark-800 rounded-2xl border border-gray-700 p-8">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="text-center p-4 bg-dark-700 rounded-lg">
                    <div className="text-2xl font-bold text-neon-blue">2022</div>
                    <div className="text-sm text-gray-400">Founded</div>
                  </div>
                  <div className="text-center p-4 bg-dark-700 rounded-lg">
                    <div className="text-2xl font-bold text-neon-green">2023</div>
              ...
              {achievements.map((achievement, index) => (
                ...
                >
                  <motion.div
                    ...
                    className="inline-flex items-center justify-center w-16 h-16 bg-dark-800 rounded-2xl border border-gray-700 mb-6 group-hover:border-neon-blue/50 transition-colors"
                  >
                    <achievement.icon className="w-8 h-8 text-neon-blue" />
                  </motion.div>
                ...
                >
                  ...
                  <div className="flex justify-center space-x-4">
                    <motion.a
                      ...
                      className="p-2 bg-dark-700 rounded-lg text-gray-400 hover:text-neon-blue transition-colors"
                    >
                ...
                <div className="flex items-center justify-between p-4 bg-dark-700 rounded-lg">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-gray-400">Security & Availability</div>
                    </div>
                  </div>
                ...
                <div className="flex items-center justify-between p-4 bg-dark-700 rounded-lg">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-gray-400">Payment Security</div>
                    </div>
                  </div>
                  <CheckCircle className="w-6 h-6 text-neon-green" />
                </div>
              ...
              {[
                ...
                >
                  <motion.div
                    ...
                    className="inline-flex items-center justify-center w-16 h-16 bg-dark-800 rounded-2xl border border-gray-700 mb-6 group-hover:border-neon-blue/50 transition-colors"
                  >
                    <value.icon className="w-8 h-8 text-neon-blue" />
                  </motion.div>
